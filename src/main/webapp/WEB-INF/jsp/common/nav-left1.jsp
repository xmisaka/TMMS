...
<div class="sidebar" id="sidebar">
	...
	<ul class="nav nav-list">
		...
		<li><a href="#" class="dropdown-toggle"> <i class="icon-book"></i>
			...
			<ul class="submenu">
				<li><a href="<%=basePath3 %>book/books"> <i
		...
		<li><a href="#" class="dropdown-toggle"> <i
			...
			<ul class="submenu">
				<li><a href="<%=basePath3 %>college/colleges"> <i class="icon-double-angle-right"></i>
						院系管理
				</a></li>
				...
				<li><a href="<%=basePath3 %>specialty/specialtys"> <i class="icon-double-angle-right"></i>
						专业管理
				</a></li>
				<li><a href="#"> <i class="icon-double-angle-right"></i>
						添加专业
		...
		<li><a href="#" class="dropdown-toggle"> <i class="icon-bold"></i>
			...
			<ul class="submenu">
				<li><a href="<%=basePath3 %>class/classs"> <i class="icon-double-angle-right"></i>
						班级管理
				</a></li>
		...
		<li><a href="#" class="dropdown-toggle"> <i class="icon-male"></i>
			...
			<ul class="submenu">
				<li><a href="<%=basePath3%>/stu/students"> <i class="icon-double-angle-right"></i>
						学生管理
				</a></li>
		...
		<li><a href="" class="dropdown-toggle"> <i class="icon-pencil"></i>
			...
			<ul class="submenu">
				<li><a href="<%=basePath3 %>teacher/teachers"> <i class="icon-double-angle-right"></i>
						教师管理
				</a></li>
	    ...
	    <li><a href="" class="dropdown-toggle"> <i class="icon-user"></i>
				<span class="menu-text"> 用户信息 </span> <b
				class="arrow icon-angle-down"></b>
		</a>

			<ul class="submenu">
				<li><a href="<%=basePath3 %>tmmsuser/tmmsusers"> <i class="icon-double-angle-right"></i>
						用户管理
				</a></li>

				<li><a href="<%=basePath3 %>userrole/userroles"> <i class="icon-double-angle-right"></i>
						角色管理
				</a></li>

				<li><a href="<%=basePath3 %>userpermission/userpermissions"> <i class="icon-double-angle-right"></i>
						权限管理
				</a></li>
		...
		<li><a href="#" class="dropdown-toggle"> <i
			...
			<ul class="submenu">
				<li><a href="<%=basePath3 %>course/courses"> <i class="icon-double-angle-right"></i>
						课程管理
				</a></li>
			...
			<li><a href="#" class="dropdown-toggle"> <i
				class="icon-list"></i> <span class="menu-text"> 菜单信息 </span> <b
				class="arrow icon-angle-down"></b>
		</a>

			<ul class="submenu">
				<li><a href="<%=basePath3 %>menuitem/menuitems"> <i class="icon-double-angle-right"></i>
						菜单管理
				</a></li>
			</ul></li>
		...
		<li><a href="#" class="dropdown-toggle"> <i class="icon-th"></i>
			...
			<ul class="submenu">
				...
				<li><a href="<%=basePath3 %>codeCatalog/codeCatalogs"> <i class="icon-double-angle-right"></i>
						参数管理
				</a></li>
