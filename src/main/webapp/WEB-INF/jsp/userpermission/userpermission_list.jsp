					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								...
								<sf:form action="userpermissions" method="post" id="Paramform"
									class="form-horizontal">
									<input type="hidden" name="currentPage" id="currentPage" value="1" />
									<div class=" col-xs-12 table-header">权限列表</div>
									...
									<div class="form-group">
										<label class="col-sm-1 contorl-label text-right">权限名</label>
										<div class="col-sm-2">
										...
										<div class="col-sm-4">
											<div id="dynamic-table_filter" class="dataTables_filter">
												<a href="userpermissionadd">
													<button type="button" class="btn btn-success btn-sm">
														<span class="icon-plus"></span>&nbsp;&nbsp;新增
													</button>
												</a>&nbsp;&nbsp; <a
													href="userpermissionsdel">
										...
										<div class="col-xs-12">
											<div class="col-sm-1">
												<input type="button" id="userpermissions" value="查 询" />
											</div>
										</div>
									...
									<table id="dynamic-table"
											...
											<thead>
												<tr>
													<th class="center"><input type="checkbox" id="all"
														onclick="selectAll('userpermissionId')" /></th>
													<th>序号</th>
													<th>权限名</th>
													<th>描述</th>
													<th>操作</th>
											...
											<tbody>
												<c:forEach items="${userpermissions}" var="userpermission" varStatus="status">
													<tr>
														<td class="center"><input type="checkbox"
															name="id" value="${userpermission.id}" /></td>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																</a> <a class="green" href="${userpermission.id}/userpermissionedit">修改 <i
																	class="icon-edit"></i>
																</a> <a class="red" href="${userpermission.id}/userpermissiondel">删除 <i
																	class="icon-trash"></i>
																</a> 
															</div>
														</td>
